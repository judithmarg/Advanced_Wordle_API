...
class AuthControllerTest {
    ...
    // --- EL FIX PARA EL ERROR JPA ---
    // Esta línea simula el contexto de base de datos para que el test no explote
    ...
    void loginShouldReturn200AndTokenWhenCredentialsAreValid() throws Exception {
        ...
        // Mockeamos el comportamiento interno del login
        // Importante: AuthenticationManager no devuelve nada, solo valida o lanza excepción
        // UserDetailsService devuelve un usuario mockeado
        // JwtService devuelve el token
